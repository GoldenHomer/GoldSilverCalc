//--------------------------------
// HIDE-SHOW PRODUCT CONTENT
//--------------------------------
function flip_tabs(layer,li){
	//--------------------------------
	// FOCUS TAB
	//--------------------------------
	document.getElementById(layer).style.display='block';
	//document.getElementById(li).className='at';
	//--------------------------------
...
if (typeof ol_fgcolor=='undefined') var ol_fgcolor="#FEFADF";

if (typeof ol_bgcolor=='undefined') var ol_bgcolor="#185F35";
